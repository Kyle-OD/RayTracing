...
class camera {
    public:
        ...
        double defocus_angle = 0;  // variation angle of rays through camera
    ...
    private: 
        ...
        point3 pixel00_loc;         // location of pixel 00 (top left)
        ...
        ray get_ray(int i, int j) {
            // Construct a camera ray from origin to randomly sampled point around pixel location (i, j)
